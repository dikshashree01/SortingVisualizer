...
function quick_partition (start, end)
{
    ...
    div_update(divs[start],div_sizes[start],"#ffcc29");//Color update
        ...
        for(var j =start + 1; j <= end ; j++ )
        {
            ...
            if (div_sizes[ j ] < piv)
            {
                ...
                div_update(divs[i],div_sizes[i],"#00adb5");//Height update
                div_update(divs[j],div_sizes[j],"#00adb5"); //Height update

                i += 1;
            }
    }
    div_update(divs[start],div_sizes[start],"#ce1212");//Color update
    ...
    div_update(divs[start],div_sizes[start],"#ce1212");//Height update
