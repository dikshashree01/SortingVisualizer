...
function max_heapify(n,i)
{
    ...
    if(l<n && div_sizes[l]>div_sizes[largest])
    {
        if(largest!=i)
        {
            div_update(divs[largest],div_sizes[largest],"#00adb5");//Color update
        }

        largest=l;

        div_update(divs[largest],div_sizes[largest],"#ce1212");//Color update
    }
...
function heap_sort()
{
    ...
    for(var i=array_size-1;i>0;i--)
    {
        ...
        div_update(divs[i],div_sizes[i],"#ffcc29");//Color update
